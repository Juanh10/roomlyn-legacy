...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-11-2023 a las 02:49:09
...
CREATE TABLE `clientes_no_registrados` (
  ...
  `ciudad_origen` char(30) NOT NULL,
...
--
-- Estructura de tabla para la tabla `info_clientes_registrados`
--

CREATE TABLE `info_clientes_registrados` (
...
--
-- Indices de la tabla `info_clientes_registrados`
--
ALTER TABLE `info_clientes_registrados`
...
--
-- AUTO_INCREMENT de la tabla `clientes_no_registrados`
--
ALTER TABLE `clientes_no_registrados`
  MODIFY `id_cl_no_reg` int(10) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `clientes_registrados`
  ADD CONSTRAINT `fk_infocliente` FOREIGN KEY (`id_info_cliente`) REFERENCES `info_clientes_registrados` (`id_info_cliente`),
...
--
ALTER TABLE `reservas`
  ADD CONSTRAINT `fk_CLiente_no_regsitrado` FOREIGN KEY (`id_cliente`) REFERENCES `clientes_no_registrados` (`id_cl_no_reg`),
  ADD CONSTRAINT `fk_clienteRegistrado` FOREIGN KEY (`id_cliente`) REFERENCES `info_clientes_registrados` (`id_info_cliente`),
