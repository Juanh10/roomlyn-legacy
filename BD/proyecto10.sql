...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-11-2023 a las 05:49:43
...
CREATE TABLE `departamento` (
  ...
  `id_nacionalidad` int(10) NOT NULL,
...
INSERT INTO `departamento` (`id_departamento`, `id_nacionalidad`, `departamento`) VALUES
(1, 1, 'No requerido'),
(2, 43, 'Amazonas'),
(3, 43, 'Antioquia'),
(4, 43, 'Arauca'),
...
CREATE TABLE `estado_reservas` (
  `id_estado_reserva` int(5) NOT NULL,
  `nombre_estado` char(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 1, 1, 1, '1 simple', 1, 0, 'Muy comodo', 1, '2023-11-04', '16:20:52', '2023-11-04 16:20:52'),
(2, 5, 1, 2, '1 doble', 2, 1, 'Muy comodo', 1, '2023-11-04', '16:21:03', '2023-11-04 16:21:03'),
(3, 1, 2, 3, '1 simple,1 doble', 3, 0, 'Muy comodo', 1, '2023-11-04', '16:21:15', '2023-11-04 16:21:15'),
(4, 1, 2, 4, '2 doble', 4, 1, 'Muy comodo', 1, '2023-11-04', '16:21:24', '2023-11-04 16:26:53'),
(5, 1, 3, 5, '3 doble', 6, 0, 'Muy comodo', 1, '2023-11-04', '16:21:34', '2023-11-04 16:21:34'),
(6, 1, 3, 6, '2 simple,1 doble', 4, 1, 'Muy comodo', 1, '2023-11-04', '16:21:46', '2023-11-04 16:21:46'),
(7, 1, 4, 7, '2 simple,2 doble', 6, 0, 'Muy comodo', 1, '2023-11-04', '16:22:02', '2023-11-04 16:22:02'),
(8, 1, 4, 8, '3 simple,1 doble', 5, 1, 'Muy comodo', 1, '2023-11-04', '16:22:12', '2023-11-04 16:22:12'),
(9, 1, 2, 9, '2 simple', 2, 1, 'Muy comodo', 1, '2023-11-06', '13:35:40', '2023-11-06 13:35:40'),
(10, 1, 2, 10, '2 simple', 2, 1, 'Muy comodo', 1, '2023-11-06', '15:20:31', '2023-11-06 15:20:31'),
(11, 1, 2, 11, '2 simple', 2, 0, 'Muy comodo', 1, '2023-11-06', '15:22:58', '2023-11-06 15:22:58'),
(12, 5, 1, 12, '1 doble', 2, 0, 'Muy comodo', 1, '2023-11-06', '15:31:26', '2023-11-06 15:31:26'),
(13, 1, 2, 13, '2 simple', 2, 0, 'Muy comodo', 1, '2023-11-06', '15:31:38', '2023-11-06 15:31:38'),
(14, 1, 2, 14, '2 simple', 2, 0, 'Muy comodo', 1, '2023-11-06', '15:31:47', '2023-11-06 15:31:47');
...
(10, 1, '2camas', '2camas.jpg', 0),
(11, 1, '2camas', '2camas.jpg', 1),
(12, 1, '3camas', '3camas.jpg', 1),
(13, 1, 'conocenos2', 'conocenos2.jpg', 1);
...
CREATE TABLE `info_clientes` (
  ...
  `id_nacionalidad` int(10) NOT NULL COMMENT 'Nacionalidad del cliente registrado',
  `id_departamento` int(10) NOT NULL,
  `id_municipio` int(10) NOT NULL COMMENT 'Ciudad de origen del cliente registrado',
...
CREATE TABLE `reservas` (
  ...
  `id_estado_reserva` int(5) NOT NULL COMMENT 'Estado de la reserva',
...
ALTER TABLE `historico_reservas`
  ADD KEY `fk_inforUsuarios` (`id_cliente`),
  ADD KEY `fk_idhabitacion` (`id_habitaciones`),
  ADD KEY `fk_idestadoreserva` (`id_estado_reserva`);
...
ALTER TABLE `reservas`
  ...
  ADD KEY `fk_id_habitacion` (`id_habitaciones`),
...
--
ALTER TABLE `departamento`
  MODIFY `id_departamento` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT de la tabla `estado_reservas`
--
ALTER TABLE `estado_reservas`
  MODIFY `id_estado_reserva` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `habitaciones`
--
ALTER TABLE `habitaciones`
  MODIFY `id_habitaciones` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único de la habitación', AUTO_INCREMENT=15;
...
--
ALTER TABLE `habitaciones_imagenes`
  MODIFY `id_hab_imagen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `habitaciones_tipos_elementos`
  MODIFY `id_hab_tipo_elemento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `info_clientes`
  MODIFY `id_info_cliente` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `municipio`
--
ALTER TABLE `municipio`
  MODIFY `id_municipio` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1123;

--
-- AUTO_INCREMENT de la tabla `nacionalidad`
--
ALTER TABLE `nacionalidad`
  MODIFY `id_nacionalidad` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=196;
...
--
ALTER TABLE `departamento`
  ADD CONSTRAINT `fk_nacionalidad` FOREIGN KEY (`id_nacionalidad`) REFERENCES `nacionalidad` (`id_nacionalidad`);
...
--
-- Filtros para la tabla `historico_reservas`
--
ALTER TABLE `historico_reservas`
  ADD CONSTRAINT `fk_idestadoreserva` FOREIGN KEY (`id_estado_reserva`) REFERENCES `estado_reservas` (`id_estado_reserva`),
  ADD CONSTRAINT `fk_idhabitacion` FOREIGN KEY (`id_habitaciones`) REFERENCES `habitaciones` (`id_habitaciones`),
  ADD CONSTRAINT `fk_inforUsuarios` FOREIGN KEY (`id_cliente`) REFERENCES `info_clientes` (`id_info_cliente`);
...
ALTER TABLE `info_clientes`
  ...
  ADD CONSTRAINT `fk_id_nacionalidad` FOREIGN KEY (`id_nacionalidad`) REFERENCES `nacionalidad` (`id_nacionalidad`);
...
ALTER TABLE `reservas`
  ...
  ADD CONSTRAINT `fk_id_habitacion` FOREIGN KEY (`id_habitaciones`) REFERENCES `habitaciones` (`id_habitaciones`);
...
-- Eventos
--
CREATE DEFINER=`root`@`localhost` EVENT `MoverReservas` ON SCHEDULE EVERY 1 MINUTE STARTS '2023-11-04 15:17:30' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
  INSERT INTO historico_reservas (id_reserva, id_cliente, id_habitaciones, id_estado_reserva, fecha_ingreso, fecha_salida, total_reserva)
  SELECT id_reserva, id_cliente, id_habitaciones, id_estado_reserva, fecha_ingreso, fecha_salida, total_reserva
  FROM reservas
  WHERE fecha_salida < CURDATE();

  -- Eliminar los registros de reservas que se movieron al historico
