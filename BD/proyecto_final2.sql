...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-11-2023 a las 21:31:04
...
--
ALTER TABLE `habitaciones_tipos_servicios`
  MODIFY `id_tipo_servicio` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único del servicio del tipo de habitación';
