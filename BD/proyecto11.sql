...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-11-2023 a las 22:59:29
...
CREATE TABLE `clientes_registrados` (
  ...
  `fecha_update` datetime NOT NULL COMMENT 'Fecha y hora de registro en el sistema'
...
CREATE TABLE `historico_reservas` (
  `id_historico_reservas` int(10) NOT NULL,
...
(1, 1, '1105674597', 'Juan', 'David', 'Hernandez', '', '3106046654', 'juandavidh052@gmail.com'),
(2, 1, '11056749878', 'Leidy', 'Vanessa', 'Barrero', 'Lozano', '3114567890', 'vanessa@gmail.com');
...
CREATE TABLE `usuarios` (
  ...
  `hora_reg` time NOT NULL COMMENT 'hora de registro',
  `fecha_update` datetime NOT NULL COMMENT 'fecha del sistema'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `historico_reservas`
  ADD PRIMARY KEY (`id_historico_reservas`),
...
--
ALTER TABLE `habitaciones`
  MODIFY `id_habitaciones` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único de la habitación';
...
--
ALTER TABLE `habitaciones_imagenes`
  MODIFY `id_hab_imagen` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `habitaciones_tipos`
--
ALTER TABLE `habitaciones_tipos`
  MODIFY `id_hab_tipo` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `habitaciones_tipos_elementos`
--
ALTER TABLE `habitaciones_tipos_elementos`
  MODIFY `id_hab_tipo_elemento` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `historico_reservas`
--
ALTER TABLE `historico_reservas`
  MODIFY `id_historico_reservas` int(10) NOT NULL AUTO_INCREMENT;
