...
?>
    <a class="btnVolverFiltro" href="javascript:location.reload(true)">Volver</a>
    <p class="msjError">Campos vacios, por favor seleccione el rango de fechas</p>
<?php
    exit;
}
...
?>
    <p class="msjError">No se encontraron reservas realizadas en el rango de fechas proporcionado.</p>
<?php
endif;
